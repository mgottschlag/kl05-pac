...
#[doc = "Field `AUTOSTOP` reader - no description available"]
...
#[doc = "Field `AUTOSTOP` writer - no description available"]
...
#[doc = "Field `AUTOHALT` reader - no description available"]
...
#[doc = "Field `AUTOHALT` writer - no description available"]
