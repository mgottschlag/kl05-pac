...
#[doc = "Field `WRAP` reader - no description available"]
...
#[doc = "Field `WRAP` writer - no description available"]
pub struct WRAP_W<'a> {
    w: &'a mut W,
}
impl<'a> WRAP_W<'a> {
...
#[doc = "Field `POINTER` reader - Trace Packet Address Pointer"]
...
#[doc = "Field `POINTER` writer - Trace Packet Address Pointer"]
...
impl R {
    ...
    #[doc = "Bits 3:31 - Trace Packet Address Pointer"]
    #[inline(always)]
