...
#[doc = "Field `CLP4` reader - no description available"]
pub struct CLP4_R(crate::FieldReader<u16, u16>);
impl CLP4_R {
    pub(crate) fn new(bits: u16) -> Self {
        CLP4_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CLP4_R {
...
#[doc = "Field `CLP4` writer - no description available"]
pub struct CLP4_W<'a> {
    w: &'a mut W,
}
impl<'a> CLP4_W<'a> {
...
impl R {
    #[doc = "Bits 0:9 - no description available"]
    #[inline(always)]
